...
<div class="container" style="margin-top: 20px;">
    ...
    <form class="form-horizontal" id="commitform">
                    ...
                    <div class="input-group-btn">
                        ...
                        <ul id="selectSpeaker" class="dropdown-menu">
                            <c:forEach items="${speakerList}" var="speaker">
                                <li value='${speaker.id}'><a href="#" onclick="showName(this,'${speaker.id}',1)">${speaker.speakerName}</a>
                                </li>
                            </c:forEach>
                    ...
                    <div class="input-group-btn">
                        ...
                        <ul id="selectCourse" class="dropdown-menu">
                            <c:forEach items="${courseList}" var="course">
                                <li value="${course.id}"><a href="#" onclick="showName(this,${course.id},2)">${course.courseTitle}</a>
                                </li>
                            </c:forEach>
        ...
        <div class="col-sm-10">
            ...
            <div id="photo"></div>
            <input type="hidden" id="imageUrl" name="videoImageUrl" class="form-control" value="${video.imageUrl}" placeholder="具体的url">
        </div>
        </div>
    </form>
...
<script>
    ...
    function commitsave() {
        $.post("${pageContext.request.contextPath}/video/saveOrUpdate",$("#commitform").serialize(),function(data){
            if(data=='success'){
